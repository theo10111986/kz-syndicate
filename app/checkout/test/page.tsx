    ...
    <div style={{ padding: 40 }}>
      ...
      >
        ...
        <input
          type="hidden"
          name="ParamBackLink"
          value="https://www.kzsyndicate.com/cart"
        />
        <input
          type="hidden"
          name="ParamSuccessURL"
          value="https://www.kzsyndicate.com/api/checkout/payment/success"
        />
        <input
          type="hidden"
          name="ParamFailureURL"
          value="https://www.kzsyndicate.com/api/checkout/payment/failure"
        />
